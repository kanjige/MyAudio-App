...
public class Song extends AudioContent implements Comparable<Song>// implement the Comparable interface
{
	...
	public void play()			//Sets audiofile to song's lyrics, prints it
	{
		setAudioFile(lyrics);
		super.play();
	}
	...
	public boolean equals(Object other)
	{
		...
		if (super.equals(othersong) == true && this.getComposer().equals(othersong.getComposer()) && this.getArtist().equals(othersong.getArtist())){
			return true;
		}
		return false;
	}
